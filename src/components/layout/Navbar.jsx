...
export const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-4 py-1 bg-gray-200 dark:bg-slate-900 text-gray-900 dark:text-white">
            ...
            <div className="flex items-center gap-3">
                ...
                >
                    {themeMode === 'dark' ? (
                        ...
                        <MoonIcon className="w-5 h-5 text-grey-700 transition-transform" />
                    )}
                </button>
